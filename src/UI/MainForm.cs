    ...
    public partial class MainForm : Form
    {
        ...
        private void TaskRunner_OnTaskCompleted(AgentTask task)
        {
            ThreadSafeUI.Run(this, delegate
            {
                ...
                // \u5982\u679c\u6709\u7522\u751f\u7684\u7a0b\u5f0f\u78bc
                if (task.Type == TaskType.GenerateCode)
                {
                    string code = AIAgentTool.Utils.HtmlHelper.ExtractCodeBlock(reply);
                ...
                {
                    trayIcon.ShowBalloonTip(3000, "\u4efb\u52d9\u5b8c\u6210",
                        Truncate(task.Query, 30), ToolTipIcon.Info);
                }
            });
        }
        ...
        private ChatSession ParseSessionJson(string json)
        {
            ...
            while (pos < arrContent.Length)
            {
                ...
                DateTime msgTime;
                if (!DateTime.TryParse(timeStr, out msgTime))
        ...
        private void SessionMenu_Rename(object sender, EventArgs e)
        {
            ...
            tb.Location = new Point(12, 15);
            tb.Size = new Size(310, 25);
            inputForm.Controls.Add(tb);

            Button btnOK = new Button();
            btnOK.Text = "\u78ba\u5b9a";
            btnOK.DialogResult = DialogResult.OK;
            btnOK.Location = new Point(165, 55);
            ...
            btnCancel.Location = new Point(247, 55);
        ...
        {
            DialogResult dr = MessageBox.Show(
                "\u78ba\u5b9a\u8981\u6e05\u9664\u6240\u6709\u5c0d\u8a71\u7d00\u9304\u55ce\uff1f\u6b64\u64cd\u4f5c\u7121\u6cd5\u5fa9\u539f\u3002",
                "\u78ba\u8a8d", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (dr != DialogResult.Yes) return;

            foreach (var s in _sessions)
            {
                string fp = Path.Combine(_sessionsDir, s.Id + ".json");
